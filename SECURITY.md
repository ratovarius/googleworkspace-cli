...
The fork maintainer coordinates reports for changes maintained here. This fork
does not promise a Google Security Team response or a fixed response time.

For vulnerabilities also affecting the original project, follow the
[upstream security policy](https://github.com/googleworkspace/cli/security/policy).
